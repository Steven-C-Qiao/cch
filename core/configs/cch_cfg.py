...
# _C.LOSS.VP_INIT_CHAMFER_LOSS_WEIGHT = 1.
# _C.LOSS.VP_CHAMFER_LOSS_WEIGHT = 1.
# _C.LOSS.W_REGULARISER_WEIGHT = 1.
_C.LOSS.USE_ASAP_LOSS_THUMAN = True
_C.LOSS.USE_ASAP_LOSS_D4DRESS = False
_C.LOSS.VC_PM_LOSS_WEIGHT = 0.2
_C.LOSS.VC_CHAMFER_LOSS_WEIGHT = 0.2

_C.LOSS.VP_INIT_CHAMFER_LOSS_WEIGHT = 0.2

_C.LOSS.VP_CHAMFER_LOSS_USE_UNCERTAINTY = False
_C.LOSS.VP_CHAMFER_LOSS_WEIGHT = 4.
_C.LOSS.SCALE_GT2PRED = 1.

_C.LOSS.W_REGULARISER_WEIGHT = 1.

_C.LOSS.USE_NORMALS = True
_C.LOSS.VP_NORMAL_LOSS_WEIGHT = 20.

_C.LOSS.USE_VC_NORMALS = True
_C.LOSS.VC_NORMAL_LOSS_WEIGHT = 10.
