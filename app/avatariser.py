...
if __name__ == '__main__':
    ...
    frame_extra_list = [f"{i:05d}" for i in range(21, 121, 5)]

    for frame_extra in frame_extra_list:
        override_choices = {
            0: {
                'take_name': ('Take1', 'Inner'),
                'extra_take_name': ('Take1', 'Inner'),
                'frames_main': ['00021', '00041', '00061', '00081'],
